...
# CONFIGURATION
# ==============================================================================
EXE_PATH  = "./LMS.exe"        # Windows: LMS.exe  |  Linux: ./LMS
LMS_FILE  = "LMS.txt"
...
class TestNavigation(unittest.TestCase):
    ...
    def test_main_menu_invalid_choice(self):
        ...
        out = run_lms("9\n3\n")
        assert_output_contains(self, out, "Invalid input", "ATC-026")
    ...
    def test_user_menu_back(self):
        ...
        out = run_lms("2\n4\n3\n")
        assert_output_contains(self, out, "Library Management System", "ATC-029")

    def test_non_integer_main_menu(self):
        """ATC-030: Non-integer at main menu handled gracefully."""
        out = run_lms("abc\n3\n")
        assert_output_contains(self, out, "Invalid input", "ATC-030")
